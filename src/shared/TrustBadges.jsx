// import badge1 from '../assets/badge1.png' // optional
// import badge2 from '../assets/badge2.png' // optional
let badge1;
let badge2
  ...
  return (
    <section className="py-10 bg-lightGray">
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 w-full">
        ...
        {badge1 
          ? <img src={badge1} alt="badge1" className="h-12 opacity-90" /> 
        ...
        {badge2 
          ? <img src={badge2} alt="badge2" className="h-12 opacity-90" /> 
