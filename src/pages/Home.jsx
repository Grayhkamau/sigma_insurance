...
import cooporate from '../assets/coorporate.jpg'
import claims from '../assets/claims.jpg'
import HeroSection from '../components/Herosection';
import heroImg from '../assets/insure_hero.jpg' 
...
export default function Home(){
  return (
    <div>
      ...
      <motion.section initial={{opacity:0}} whileInView={{opacity:1}} viewport={{once:false}} transition={{duration:1}} className="py-16 bg-lightGray flex ">
      ...
      <section className="py-16 bg-cream">
        <div className="flex flex-col gap-6 w-full">
          <h2 className="text-2xl font-bold text-logoNavy">Why Sigma Insurance</h2>
